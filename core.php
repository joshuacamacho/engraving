...
function printorders($userid,$link){
	  ...
	  echo "<td>Order Page</td>";
		...
		while($row=mysqli_fetch_array($result)){
			...
			if(onDashboard())echo "<td><a href='../orderpage.php?order=".$orderid."'>Order Page</a></td>";
			else echo "<td><a href='orderpage.php?order=".$orderid."'>Order Page</a></td>";
			...
			while($row2 = mysqli_fetch_assoc($result2)){
				...
				echo "<td>$".sprintf('%01.2f', $row['totalprice'] )."</td>";//price
